...
class Promedio(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Practica_0", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Practica_0")
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_f((1.96,1.98,1.88,1.85,2.01,1.96,1.98,1.99,2.13,1.75,2.05), True, 1, [])
        ...
        for i in range(1):
            self.RMS.set_min(i, -2)
            self.RMS.set_max(i, 2)
        ...
        for i in range(1):
            self.Potencia_Promedio.set_min(i, -4)
            self.Potencia_Promedio.set_max(i, 4)
        ...
        for i in range(1):
            self.Media_Cuadratica.set_min(i, -4)
            self.Media_Cuadratica.set_max(i, 4)
        ...
        for i in range(1):
            self.Media.set_min(i, -2)
            self.Media.set_max(i, 2)
        ...
        for i in range(1):
            self.Desviacion_Estandar.set_min(i, -2)
