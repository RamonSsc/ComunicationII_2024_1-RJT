...
class acumulador(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "suma prueba")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("suma prueba")
        ...
        labels = ['original', 'acumulador', 'diferenciador', 'Signal 4', 'Signal 5',
        ...
        self.connect((self.epy_block_1, 0), (self.qtgui_time_sink_x_0, 2))
